...
class File
{
    public static function saveCSVFile(string $file, array $values, array $columns = []): void
    {
     ...
     * @throws Exception
     */
    public static function readCSVString(string $string, array $columns = [], bool $firstLineColumns = false): array
    {
        $values = [];
     ...
     * @throws Exception
     */
    public static function readCSVFile(string $file, array $columns = [], bool $firstLineColumns = false): array
    {
        return self::readCSVString(file_get_contents($file), $columns, $firstLineColumns);
    }

    public static function readFileSize($file, $size, $callback, $breakIteration = 0): void
    {
        $i = 0;
        $handle = @fopen($file, "r");
